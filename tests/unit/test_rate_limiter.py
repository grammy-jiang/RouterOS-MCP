...
def test_rate_limiter_allows_within_limit() -> None:
    ...
    assert limiter.get_remaining("dev-001", "ping", limit=10, window_seconds=60) == 0
...
def test_rate_limiter_sliding_window() -> None:
    ...
    # Fill up to limit
    for _i in range(10):
        limiter.check_and_record("dev-001", "ping", limit=10, window_seconds=1)
    ...
    limiter.check_and_record("dev-001", "ping", limit=10, window_seconds=1)
    assert limiter.get_remaining("dev-001", "ping", limit=10, window_seconds=1) == 9


def test_rate_limiter_per_device_isolation() -> None:
    ...
    limiter.check_and_record("dev-002", "ping", limit=10, window_seconds=60)
    assert limiter.get_remaining("dev-002", "ping", limit=10, window_seconds=60) == 9


def test_rate_limiter_per_operation_isolation() -> None:
    ...
    limiter.check_and_record("dev-001", "traceroute", limit=10, window_seconds=60)
    assert limiter.get_remaining("dev-001", "traceroute", limit=10, window_seconds=60) == 9
...
def test_rate_limiter_reset_all() -> None:
    ...
    # Record operations
    limiter.check_and_record("dev-001", "ping", limit=10, window_seconds=60)
    limiter.check_and_record("dev-002", "traceroute", limit=10, window_seconds=60)

    # Reset all
    limiter.reset()

    # Should have full quota again
    assert limiter.get_remaining("dev-001", "ping", limit=10, window_seconds=60) == 10
    assert limiter.get_remaining("dev-002", "traceroute", limit=10, window_seconds=60) == 10


def test_rate_limiter_reset_device() -> None:
...
def test_rate_limiter_reset_operation() -> None:
...
def test_rate_limiter_reset_device_and_operation() -> None:
...
def test_reset_rate_limiter_global() -> None:
...
def test_rate_limiter_get_remaining_accuracy() -> None:
    ...
    assert limiter.get_remaining("dev-001", "ping", limit=10, window_seconds=60) == 7
